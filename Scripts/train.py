print("Refer to README.md file to set access token for tabpfn if you are interested in the foundation model.\nIf not, stop and comment that part out and rerun the pipeline")
import subprocess

def install_from_file(file_path="requirements.txt"):
...
def train(df):
    ...
    return cordinates, y_log, goal_log, y_rf, goal_rf, y_xgb, goal_xgb, y_cat, goal_cat, y_tabPFN, goal_tabPFN, y_test
